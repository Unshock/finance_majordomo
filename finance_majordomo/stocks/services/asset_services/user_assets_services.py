...
from finance_majordomo.stocks.models.asset import AssetsHistoricalData
from finance_majordomo.stocks.services.transaction_services.transaction_calculation_services \
    import get_asset_quantity_for_portfolio
