...
from finance_majordomo.stocks.models.models import DividendsOfUser
...
class TestDividendsViews(SettingsDividends):
    ...
    def setUp(self):
        ...
        self.remove_dividend = reverse(
            'remove_div_from_user', kwargs={'pk_dividend': 2})

    def test_urls_to_views(self):
        self.assertEqual(resolve(self.list_url).func.view_class,
                         views.Dividends)
        self.assertEqual(resolve(self.add_dividend).func.view_class,
                         views.AddDivToUser)
        self.assertEqual(resolve(self.remove_dividend).func.view_class,
                         views.RemoveDivFromUser)
