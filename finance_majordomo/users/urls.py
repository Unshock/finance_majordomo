...
urlpatterns = [
    ...
    path("add_stock/<int:pk_stock>/", views.AddStockToUser.as_view(),
         name="add_stock_to_user"),
    path("add_asset/<int:pk_asset>/", views.AddAssetToPortfolio.as_view(),
         name="add_asset_to_portfolio"),
